...
import dao.provider.EmployeeDynaSqlProvider;
import domain.Employee;
import org.apache.ibatis.annotations.*;
import org.apache.ibatis.mapping.FetchType;
import static util.HrmConstants.EMPLOYEETABLE;
...
public interface EmployeeDao {
    ...
    @Results({
            ...
            @Result(column = "DEPT_ID",property = "dept",one = @One(select = "main.java.dao.DeptDao.selectById",fetchType = FetchType.EAGER)),
            @Result(column = "JOB_ID",property = "job",one = @One(select = "main.java.dao.JobDao.selectById",fetchType = FetchType.EAGER))
    })
